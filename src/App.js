...
class App extends Component {
  ...
  render() {
    const {category, score, time, imgUrl, isGameOver} = this.state
        ...
        <div className="app-container">
          <nav className="nav-container">
            ...
            <div className="nav-score-container">
              <div>
                <p>
                  Score: <span className="count-color">{score}</span>
                </p>
              </div>
              <div className="timer-container">
                <img
                  ...
                  alt="timer"
                />
                <p className="count-color">{time} sec</p>
              </div>
            </div>
          </nav>
          <div className="game-container">
            {!isGameOver && (
              <div className="question-image-container">
                <ul>
                  <img src={imgUrl} className="game-image" alt="match" />
                </ul>
                  ...
                  {tabsList.map(eachValue => (
                    <li key={eachValue.tabId}>
                      <button
                        type="button"
                        className="btn-style"
                        onClick={() => this.onTabButtonClick(eachValue.tabId)}
                      >
                  ...
                  {thumbnailList.map(eachImage => (
                    <li key={eachImage.id}>
                      <button
                        ...
                        className="btn-style"
                        onClick={() =>
                          this.onImageClicked(eachImage.thumbnailUrl)
                        }
                      >
                        <img
